jQuery(window).load(function () {
  jQuery(".styleswitcher").animate({ left: "-240px" }),
    ...
    jQuery(".switch-btn").on("click", function () {
      jQuery(this).hasClass("open")
        ...
        : jQuery(this).hasClass("closed") &&
          ...
          jQuery(".styleswitcher").animate({ left: "0px" }));
    });
  }),
  jQuery(document).ready(function () {
    jQuery(".skin-1").on("click", function () {
      return (
        ...
        jQuery(".header-style-3 .logo-header img").attr(
          "src",
          "images/logo-light-1.png"
        ),
        jQuery(".header-style-5 .logo-header img").attr(
          "src",
          "images/logo-light-1.png"
        ),
