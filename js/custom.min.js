!function(e) {
    ...
    function i() {
        jQuery(window).on("scroll", function() {
            jQuery(".progress-bar").each(function() {
                i = jQuery(this).attr("aria-valuenow"),
                jQuery(this).width(i + "%")
            })
        })
    }
    jQuery(document).ready(function() {
        ...
        jQuery.support.placeholder || (jQuery("[placeholder]").on("focus", function() {
        ...
        jQuery("<div class='fa fa-close submenu-toogle'>hocomoco-construction-services-navigation----------------------------------------------------------------------------------------------------------------------------------------------------------------------</div>").insertAfter(".has-child > a"),
        ...
        function() {
            if (jQuery().isotope) {
                ...
                jQuery(".masonry-filter li").on("click", function() {
                    ...
                    return jQuery(".masonry-filter li").removeClass("active"),
    ...
    jQuery(document).on("submit", "form.cons-contact-form", function(e) {
        ...
        return jQuery.ajax({
            ...
            success: function(e) {
                ...
                e.success ? jQuery("<div class='alert alert-success'>" + e.message + "</div>").insertBefore("form.cons-contact-form") : jQuery("<div class='alert alert-danger'>" + e.message + "</div>").insertBefore("form.cons-contact-form")
            }
        }),
    ...
    jQuery(document).on("submit", "form.cons-contact-form2", function(e) {
        ...
        return jQuery.ajax({
            ...
            success: function(e) {
                jQuery(".loading-area").hide(),
                e.success ? jQuery("<div class='alert alert-success'>" + e.message + "</div>").insertBefore("form.cons-contact-form2") : jQuery("<div class='alert alert-danger'>" + e.message + "</div>").insertBefore("form.cons-contact-form2")
            }
        }),
