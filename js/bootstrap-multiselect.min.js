    ...
    i.prototype = {
                            ...
                            if (this.query !== e.target.value) {
                                ...
                                t.each(t("li", this.$ul), t.proxy(function(e, l) {
                                    ...
                                    o !== this.options.selectAllValue && n) {
                                        ...
                                        s = p) : (p && t(i).show().removeClass("filter-hidden"),
                                        !p && s && t(l).show().removeClass("filter-hidden"))
                                    }
                                }, this))
                            }
                            this.updateSelectAll()
            ...
            t("option", this.$select).each(t.proxy(function(i, s) {
                for (var l, o = t(s), n = o.val(), a = e.length; 0 < a--; )
                    if (n === (l = e[a]).val()) {
                        ...
                        this.options.selectedClass && l.closest("li").addClass(this.options.selectedClass)) : (l.prop("checked", !1),
                        this.options.selectedClass && l.closest("li").removeClass(this.options.selectedClass)),
        ...
        updateSelectAll: function(e) {
            if (this.hasSelectAll()) {
                ...
                this.options.onSelectAll(!0)) : (n.prop("checked", !1),
